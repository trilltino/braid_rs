...
fn test_crdt_concurrent_convergence() {
    ...
    let _ = layer
        .resource_manager
        .apply_remote_insert("doc", "alice", 0, "a");
    let _ = layer
        .resource_manager
        .apply_remote_insert("doc", "bob", 1, "b");
    let _ = layer
        .resource_manager
        .apply_remote_insert("doc", "alice", 2, "c");
    let _ = layer
        .resource_manager
        .apply_remote_insert("doc", "bob", 0, "x");
...
fn test_resource_state_after_operations() {
    ...
    let _ = layer
        .resource_manager
        .apply_update("doc1", "hello world", "alice");
