...
//!
//! ```
//! use braid_http_rs::vendor::diamond_types::list::*;
//!
...
#![allow(unused_imports, dead_code)] // Vendor code - keep dead code for API completeness
...
pub use crate::vendor::diamond_types::frontier::Frontier;
pub use crate::vendor::rle::HasLength;

use crate::vendor::diamond_types::causalgraph::agent_assignment::remote_ids::{
    RemoteFrontierOwned, RemoteVersion, RemoteVersionOwned,
};
use crate::vendor::diamond_types::causalgraph::agent_span::AgentVersion;
pub use crate::vendor::diamond_types::causalgraph::CausalGraph;
pub use crate::vendor::diamond_types::dtrange::DTRange;
use crate::vendor::diamond_types::list::op_metrics::{ListOpMetrics, ListOperationCtx};

use crate::vendor::diamond_types::rle::{KVPair, RleVec};
use crate::vendor::diamond_types::textinfo::TextInfo;

// use crate::vendor::diamond_types::list::internal_op::OperationInternal as TextOpInternal;
    ...
    fn from(ops: SerializedOps<'a>) -> Self {
        Self {
            ...
            text_ops: ops
                .text_ops
                .into_iter()
                .map(|(crdt_name, rv, metrics)| (crdt_name.to_owned(), rv.to_owned(), metrics))
                .collect(),
...
impl<'a> SerializedOps<'a> {
    pub fn to_owned(self) -> SerializedOpsOwned {
        self.into()
    }
}
