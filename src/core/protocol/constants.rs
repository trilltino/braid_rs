...
//! use crate::core::protocol::constants::{headers, merge_types};
//!
...
///
/// ```
/// use crate::core::protocol::STATUS_SUBSCRIPTION;
///
...
///
/// ```
/// use crate::core::protocol::STATUS_MERGE_CONFLICT;
///
...
///
/// ```
/// use crate::core::protocol::merge_types;
///
/// assert_eq!(merge_types::DIAMOND, "diamond");
/// assert_eq!(merge_types::SYNC9, "sync9");
/// ```
pub mod merge_types {
    /// Simple synchronization merge type.
    pub const SYNC9: &str = "sync9";
